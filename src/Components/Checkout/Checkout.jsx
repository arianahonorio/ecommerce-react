...
const Checkout = () => {
    ...
    //Verificación de campos completados
    if (!nombre || !apellido || !telefono || !email || !emailConfirmacion) {
        setError("Por favor completa todos los campos o moriras rata");
        return;
    }

    //Validación de los campos de email para que coincida:
    if (email !== emailConfirmacion) {
        setError("Los campos de email no coinciden, maldito insectoooo!");
        return;
    }

    //Creación de un objeto con los datos de la orden de compra:
    ...
    //Modificación para que el código ejecute promesas
